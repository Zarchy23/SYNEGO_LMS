...
class Module(models.Model):
    ...
    code = models.CharField(max_length=20, unique=True, help_text="Module code (e.g., BT, EME, CE)")
    description = models.TextField()
    mission = models.TextField(blank=True, help_text="Module mission statement")
    vision = models.TextField(blank=True, help_text="Module vision statement")
    ...
    head = models.ForeignKey(
        ...
        limit_choices_to={'role__in': ['module_head', 'admin']},
        related_name='headed_modules'
    )
...
class Course(models.Model):
    ...
    department = models.ForeignKey(Module, on_delete=models.CASCADE, related_name='courses')
    ...
    # Module categorization (Technical, Non-Technical, Leadership)
    module_type = models.CharField(max_length=20, choices=MODULE_TYPE_CHOICES, default='technical', help_text="Categorize course into Technical, Non-Technical, or Leadership")
