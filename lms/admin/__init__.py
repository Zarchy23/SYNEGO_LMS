...
from django.db.models import Count, Avg, Q, Q as models_Q
from ..models import (
...
class CustomUserAdmin(UserAdmin):
    list_display = ('username', 'email', 'get_full_name', 'role', 'module', 'is_approved', 'is_active', 'last_login')
    list_filter = ('role', 'is_approved', 'is_active', 'module', 'gender')
    ...
    fieldsets = (
        ...
        ('Role & Module', {'fields': ('role', 'module')}),
    ...
    add_fieldsets = (
        (None, {
            'classes': ('wide',),
            'fields': ('username', 'email', 'password1', 'password2', 'role', 'module'),
        }),
    )
...
class ChapterAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ('Content', {'fields': ('video_url', 'content', 'content_html', 'document_file')}),
...
class DashboardStats(admin.AdminSite):
    ...
    def index(self, request, extra_context=None):
        ...
        extra_context['total_departments'] = Module.objects.filter(status='active').count()
        ...
        courses = Course.objects.filter(is_active=True).annotate(
            student_count=Count('enrollments', filter=models_Q(enrollments__status='active')),
...
# ============================================================================
# PHASE 2A ADMIN - Import to auto-register all Phase 2A model admins
# ============================================================================
from . import phase2_admin  # noqa: F401, E402
